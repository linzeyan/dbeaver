        ...
        loop {
            ...
            return match token {
                ReceivedToken::NewResultset(meta) => {
                    // Through `TokenColMetaData::columns` rather than building
                    // the same thing again here: this was a second copy of that
                    // mapping, and the two had to agree about every field a
                    // column carries.
